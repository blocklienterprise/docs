...
description: "Trigger iOS and Android builds from Studio using EAS Build."
---

Studio uses EAS Build to compile and sign your iOS and Android binaries in the cloud. You don't need a local build environment — everything runs remotely.
