...
When you enable edge cache cdn, Studio reads the latest configuration from WordPress, composes it into a single app-config JSON, and pushes it to the CDN. The app fetches this config on startup.
